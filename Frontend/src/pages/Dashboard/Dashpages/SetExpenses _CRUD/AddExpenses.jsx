                    ...
                    <form class={SetExpensesStyles.form} onSubmit={handleAdd} method="POST">
                        <div class={SetExpensesStyles.form_group}>
                            ...
                            <input type="text" id="id" name="id"
                                placeholder="Merchant id of the reciever" required />
                        </div>
                        <br />
                        <label>
                            <input type="checkbox" name="T&C" id="T&C" required /><Link     to="/T&C">Term & Condition</Link>
                        </label>
                        <p>
